...
const CIRCUITS: Record<string, CircuitInfo> = {
  ...
  // ── Bahrain GP (ospitato a Sepang) – Sepang International Circuit, Malesia ──
  bahrain: {
    label: 'Sepang',
    startLine: [66, 120, 66, 132],
    d: `M 66,140 L 66,108 Q 66,92 50,88 Q 34,84 36,68 Q 38,52 54,50
        L 84,46 Q 98,44 96,30 L 92,16 Q 90,4 104,4
        L 140,4 Q 158,4 162,20 L 168,44 Q 172,60 158,66
        L 130,74 Q 114,78 118,94 L 126,112 Q 132,128 116,134
        L 90,140 Q 76,142 66,140 Z`,
  },
